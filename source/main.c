...
void compression_usage(const uint8_t *context, const size_t context_byte_len) {
  ...
  const uint8_t packet[] = {
      ...
      0x00, 0x00, 0x00, 0x20, 0xd1, 0x00, 0x16, 0x33, 0x00, 0x38, 0xbe, 0x8a,
      0x48, 0x02, 0x84, 0x81, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
      0xb2, 0x56, 0x34, 0x33, 0x77, 0x00, 0xff, 0x0d, 0x02, 0x0a, 0x0b, 0x0c,
...
void decompression_usage(const uint8_t *context,
  ...
  const uint8_t cschc_packet[] = {
      0x40, 0x97, 0xf8, 0x07, 0xa0, 0x00, 0x81, 0x01, 0x82, 0x02, 0x83,
      0x03, 0x84, 0x78, 0x82, 0xb1, 0xa5, 0xef, 0x01, 0x41, 0x61, 0x81,
   ...
   */
  size_t packet_size = decompress(packet, 100, DI_DW, cschc_packet,
...
int main(void) {
   ...
   *
   * @details 5 Rule Descriptors and 57 Rule Field Descriptors.
  ...
  const uint8_t context[] = {
      ...
      2, 107, 2, 117, 2, 127, 2, 137, 2, 145, 2, 155, 2, 165, 2, 175, 2,
      183,  // Rule Descriptor n° 0
      1, 0, 37, 1, 67, 2, 193, 1, 93, 1, 109, 1, 117, 1, 127, 1, 137, 1, 147, 1,
      157, 1, 167, 1, 177, 1, 187, 1, 197, 1, 207, 1, 217, 1, 225, 1, 233, 1,
      243, 1, 253, 2, 7, 2, 205, 2, 37, 2, 45, 2, 55, 2, 65, 2, 73, 2, 83, 2,
      93, 2, 107, 2, 117, 2, 127, 2, 137, 2, 145, 2, 155, 2, 165, 2, 175, 2,
      183,  // Rule Descriptor n° 1
      2, 0, 37, 1, 67, 2, 217, 1, 93, 1, 109, 1, 117, 1, 127, 1, 137, 1, 147, 1,
      157, 1, 167, 1, 177, 1, 187, 1, 197, 1, 207, 1, 217, 1, 225, 1, 233, 1,
      243, 1, 253, 2, 7, 2, 225, 2, 37, 2, 45, 2, 55, 2, 65, 2, 73, 2, 83, 2,
      93, 2, 107, 2, 117, 2, 127, 2, 137, 2, 145, 2, 155, 2, 165, 2, 175, 2,
      183,  // Rule Descriptor n° 2
      3, 0, 37, 1, 67, 2, 217, 2, 233, 1, 109, 1, 117, 1, 127, 1, 137, 1, 147,
      1, 157, 1, 167, 1, 177, 1, 187, 1, 197, 1, 207, 1, 217, 1, 225, 2, 241, 2,
      249, 3, 1, 3, 9, 2, 225, 2, 37, 3, 17, 3, 25, 2, 65, 3, 33, 3, 41, 3, 49,
      3, 57, 3, 65, 3, 73, 2, 137, 3, 81, 3, 89, 3, 97, 2, 175, 2,
      183,      // Rule Descriptor n° 3
      4, 1, 0,  // Rule Descriptor n° 4

      // Rule Field Descriptors
      0x13, 0xcc, 0x0, 0x4, 0x0, 0x1, 0x40, 0x1, 0x3,
      0x69,  // Rule Field Descriptor n° 0
      0x13, 0xc9, 0x0, 0x8, 0x0, 0x1, 0x5a, 0x4, 0x3, 0x6a, 0x3, 0x6b, 0x3,
      0x6c, 0x3, 0x6d,  // Rule Field Descriptor n° 1
      0x13, 0xc5, 0x0, 0x14, 0x0, 0x1, 0x5a, 0x4, 0x3, 0x6e, 0x3, 0x71, 0x3,
      0x74, 0x3, 0x77,  // Rule Field Descriptor n° 2
      0x13, 0xc8, 0x0, 0x10, 0x0, 0x1, 0x4c, 0x0,  // Rule Field Descriptor n° 3
      0x13, 0xc7, 0x0, 0x8, 0x0, 0x1, 0x40, 0x1, 0x3,
      0x7a,  // Rule Field Descriptor n° 4
      0x13, 0xc6, 0x0, 0x8, 0x0, 0x1, 0x40, 0x1, 0x3,
      0x7b,  // Rule Field Descriptor n° 5
      0x13, 0xc1, 0x0, 0x80, 0x0, 0x1, 0x0, 0x1, 0x3,
      0x7c,  // Rule Field Descriptor n° 6
      0x13, 0xc1, 0x0, 0x80, 0x0, 0x1, 0x20, 0x1, 0x3,
      0x8c,  // Rule Field Descriptor n° 7
      0x13, 0xc4, 0x0, 0x80, 0x0, 0x1, 0x0, 0x1, 0x3,
      0x8c,  // Rule Field Descriptor n° 8
      0x13, 0xc4, 0x0, 0x80, 0x0, 0x1, 0x20, 0x1, 0x3,
      0x7c,  // Rule Field Descriptor n° 9
      0x13, 0xce, 0x0, 0x10, 0x0, 0x1, 0x0, 0x1, 0x3,
      0x9c,  // Rule Field Descriptor n° 10
      0x13, 0xce, 0x0, 0x10, 0x0, 0x1, 0x20, 0x1, 0x3,
      0x9e,  // Rule Field Descriptor n° 11
      0x13, 0xd1, 0x0, 0x10, 0x0, 0x1, 0x0, 0x1, 0x3,
      0x9e,  // Rule Field Descriptor n° 12
      0x13, 0xd1, 0x0, 0x10, 0x0, 0x1, 0x20, 0x1, 0x3,
      0x9c,  // Rule Field Descriptor n° 13
      ...
      0xa0,  // Rule Field Descriptor n° 16
      0x13, 0xbe, 0x0, 0x2, 0x0, 0x1, 0x40, 0x1, 0x3,
      0xa1,  // Rule Field Descriptor n° 17
      0x13, 0xbc, 0x0, 0x4, 0x0, 0x1, 0x40, 0x1, 0x3,
      0xa2,  // Rule Field Descriptor n° 18
      0x13, 0x9f, 0x0, 0x8, 0x0, 0x1, 0x40, 0x1, 0x3,
      0xa3,  // Rule Field Descriptor n° 19
      0x13, 0xa2, 0x0, 0x10, 0x0, 0x1, 0x5a, 0x6, 0x3, 0xa4, 0x3, 0xa6, 0x3,
      0xa8, 0x3, 0xaa, 0x3, 0xac, 0x3, 0xae,  // Rule Field Descriptor n° 20
      0x13, 0xbd, 0x0, 0x0, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 21
      0x14, 0x10, 0x0, 0x4, 0x0, 0x1, 0x40, 0x1, 0x3,
      0xb0,  // Rule Field Descriptor n° 22
      0x14, 0x12, 0x0, 0x4, 0x0, 0x1, 0x40, 0x1, 0x3,
      0xb1,  // Rule Field Descriptor n° 23
      0x14, 0x14, 0x0, 0x0, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 24
      0x14, 0x10, 0x0, 0x4, 0x0, 0x2, 0x40, 0x1, 0x3,
      0xb2,  // Rule Field Descriptor n° 25
      0x14, 0x12, 0x0, 0x4, 0x0, 0x2, 0x40, 0x1, 0x3,
      0xb2,  // Rule Field Descriptor n° 26
      0x14, 0x14, 0x0, 0x0, 0x0, 0x2, 0x5a, 0x3, 0x3, 0xb3, 0x3, 0xb6, 0x3,
      0xb9,  // Rule Field Descriptor n° 27
      0x14, 0x10, 0x0, 0x4, 0x0, 0x3, 0x40, 0x1, 0x3,
      0xbc,  // Rule Field Descriptor n° 28
      0x14, 0x12, 0x0, 0x4, 0x0, 0x3, 0x40, 0x1, 0x3,
      0xbd,  // Rule Field Descriptor n° 29
      0x14, 0x13, 0x0, 0x0, 0x0, 0x1, 0x40, 0x1, 0x3,
      0xa3,  // Rule Field Descriptor n° 30
      0x14, 0x14, 0x0, 0x0, 0x0, 0x3, 0x4b, 0x0,  // Rule Field Descriptor n° 31
      0x14, 0x10, 0x0, 0x4, 0x0, 0x4, 0x40, 0x1, 0x3,
      0xbd,  // Rule Field Descriptor n° 32
      0x14, 0x12, 0x0, 0x4, 0x0, 0x4, 0x40, 0x1, 0x3,
      0xb1,  // Rule Field Descriptor n° 33
      0x14, 0x11, 0x0, 0x0, 0x0, 0x1, 0x40, 0x1, 0x3,
      0xbe,  // Rule Field Descriptor n° 34
      0x14, 0x14, 0x0, 0x0, 0x0, 0x4, 0x4b, 0x0,  // Rule Field Descriptor n° 35
      0x14, 0x15, 0x0, 0x8, 0x0, 0x1, 0x40, 0x1, 0x3,
      0x6a,  // Rule Field Descriptor n° 36
      0x13, 0xc9, 0x0, 0x8, 0x0, 0x1, 0x51, 0x0, 0x4, 0x1, 0x3,
      0xbf,  // Rule Field Descriptor n° 37
      0x13, 0xa2, 0x0, 0x10, 0x0, 0x1, 0x51, 0x0, 0xa, 0x1, 0x3,
      0xc0,  // Rule Field Descriptor n° 38
      0x13, 0xc9, 0x0, 0x8, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 39
      0x13, 0xa2, 0x0, 0x10, 0x0, 0x1, 0x4b,
      0x0,  // Rule Field Descriptor n° 40
      0x13, 0xc5, 0x0, 0x14, 0x0, 0x1, 0x4b,
      0x0,  // Rule Field Descriptor n° 41
      0x13, 0xbf, 0x0, 0x2, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 42
      0x13, 0xbe, 0x0, 0x2, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 43
      0x13, 0xbc, 0x0, 0x4, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 44
      0x13, 0x9f, 0x0, 0x8, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 45
      0x14, 0x10, 0x0, 0x4, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 46
      0x14, 0x12, 0x0, 0x4, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 47
      0x14, 0x10, 0x0, 0x4, 0x0, 0x2, 0x4b, 0x0,  // Rule Field Descriptor n° 48
      0x14, 0x12, 0x0, 0x4, 0x0, 0x2, 0x4b, 0x0,  // Rule Field Descriptor n° 49
      0x14, 0x14, 0x0, 0x0, 0x0, 0x2, 0x4b, 0x0,  // Rule Field Descriptor n° 50
      0x14, 0x10, 0x0, 0x4, 0x0, 0x3, 0x4b, 0x0,  // Rule Field Descriptor n° 51
      0x14, 0x12, 0x0, 0x4, 0x0, 0x3, 0x4b, 0x0,  // Rule Field Descriptor n° 52
      0x14, 0x13, 0x0, 0x0, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 53
      0x14, 0x10, 0x0, 0x4, 0x0, 0x4, 0x4b, 0x0,  // Rule Field Descriptor n° 54
      0x14, 0x12, 0x0, 0x4, 0x0, 0x4, 0x4b, 0x0,  // Rule Field Descriptor n° 55
      0x14, 0x11, 0x0, 0x0, 0x0, 0x1, 0x4b, 0x0,  // Rule Field Descriptor n° 56
